...
Existing User Mode: Select a User ID from the dataset to see personalized recommendations generated by our Hybrid Model. This demonstrates how we predict books for users with known borrowing habits.
