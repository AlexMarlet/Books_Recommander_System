...
## 🛠 Execution Guide (Offline Website)
...
Navigation: Use the sidebar to switch between the "Interactive Book" (Magic Book Animation) and "Data Insights" (Statistics).

Inference: Select a User ID to see personalized recommendations generated by our hybrid model.
