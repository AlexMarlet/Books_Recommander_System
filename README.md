...
Our results is a **@MAP10 of 0.16815** (which is 10,02420991% better than the baseline)  
That allow us to get the 13th place in the kaggle ranking (13/25)
...
To evaluate our AI Librarian website locally, please follow these steps. The application runs fully offline using pre-computed data.
...
First, navigate into the app folder, then run the Streamlit application:
...
The app should automatically open in your browser at http://localhost:8501. Use the sidebar to switch between two main experiences:<br>
Interactive Book (The AI Librarian):<br>
This is the main interface where you can test our recommendation engine in two ways:<br>
Existing User Mode: Select a User ID from the dataset to see personalized recommendations generated by our Hybrid Model. This demonstrates how we predict books for users with known borrowing habits.<br>
...
And here is a link for an briefly exlpicative vidéo on the project (about the data cleaning/enrichment, the recommender and the streamlit app): https://youtu.be/d-T3ZXmGz_M
